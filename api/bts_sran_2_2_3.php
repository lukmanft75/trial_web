<?php 
	...
	$atd_id = $_GET["atd_id"];
	$indottech_bts_sran_2_2_3 = $db->fetch_all_data("indottech_bts_sran_2_2_3",[],"atd_id='".$atd_id."'")[0];
	...
	if(isset($_POST["save"])){
		...
		if($indottech_bts_sran_2_2_3["id"] > 0) 		$db->where("id",$indottech_bts_sran_2_2_3["id"]);
		...
		if($indottech_bts_sran_2_2_3["id"] > 0) $inserting = $db->update();
		...
		<td>
			...
			<table align="center" border="1">
				<tr align="center">
					...
					<td>BTS Restart</td>
					<td><?=$f->select("bts_restart",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_2_3["bts_restart"], "required");?></td>
				<tr>
					<td>Launch & connection<br>BTS from WEB browser</td>
					<td><?=$f->select("launch",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_2_3["launch"], "required");?></td>
				</tr>
			</table>
			<table width="100%">
				<tr>
