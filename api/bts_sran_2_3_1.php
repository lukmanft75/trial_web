<?php 
	...
	$atd_id = $_GET["atd_id"];
	$indottech_bts_sran_2_3_1 = $db->fetch_all_data("indottech_bts_sran_2_3_1",[],"atd_id='".$atd_id."'")[0];
	...
	if(isset($_POST["save"])){
		...
		if($indottech_bts_sran_2_3_1["id"] > 0) 		$db->where("id",$indottech_bts_sran_2_3_1["id"]);
		...
		if($indottech_bts_sran_2_3_1["id"] > 0) $inserting = $db->update();
		...
		<td>
			...
			<table align="center" border="1">
				...
				<tr align="left">
					...
					<td>
						<?=$f->input("cell_id_no_1",$indottech_bts_sran_2_3_1["cell_id_no_1"],"required","classinput");?><br>
						<?=$f->input("cell_id_no_2",$indottech_bts_sran_2_3_1["cell_id_no_2"],"required","classinput");?><br>
						<?=$f->input("cell_id_no_3",$indottech_bts_sran_2_3_1["cell_id_no_3"],"required","classinput");?>
					</td>
				</tr>
				<tr align="left">
					<td>Orginating Call</td>
					<td>
						<?=$f->input("originating_call_1",$indottech_bts_sran_2_3_1["originating_call_1"],"required","classinput");?><br>
						<?=$f->input("originating_call_2",$indottech_bts_sran_2_3_1["originating_call_2"],"required","classinput");?><br>
						<?=$f->input("originating_call_3",$indottech_bts_sran_2_3_1["originating_call_3"],"required","classinput");?>
					</td>
				</tr>
				<tr align="left">
					<td>Terminating Call</td>
					<td>
						<?=$f->input("terminating_call_1",$indottech_bts_sran_2_3_1["terminating_call_1"],"required","classinput");?><br>
						<?=$f->input("terminating_call_2",$indottech_bts_sran_2_3_1["terminating_call_2"],"required","classinput");?><br>
						<?=$f->input("terminating_call_3",$indottech_bts_sran_2_3_1["terminating_call_3"],"required","classinput");?>
					</td>
				</tr>
				<tr align="left">
					<td>Open Browser (GPRS/EDGE)</td>
					<td>
						<?=$f->input("open_browser_1",$indottech_bts_sran_2_3_1["open_browser_1"],"required","classinput");?><br>
						<?=$f->input("open_browser_2",$indottech_bts_sran_2_3_1["open_browser_2"],"required","classinput");?><br>
						<?=$f->input("open_browser_3",$indottech_bts_sran_2_3_1["open_browser_3"],"required","classinput");?>
					</td>
				</tr>
			</table>
			<br>
