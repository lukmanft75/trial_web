<?php 
	...
	$atd_id = $_GET["atd_id"];
	$indottech_bts_sran_2_1_2 = $db->fetch_all_data("indottech_bts_sran_2_1_2",[],"atd_id='".$atd_id."'")[0];
	...
	if(isset($_POST["save"])){
		...
		if($indottech_bts_sran_2_1_2["id"] > 0) 	$db->where("id",$indottech_bts_sran_2_1_2["id"]);
		...
		if($indottech_bts_sran_2_1_2["id"] > 0) $inserting = $db->update();
		else $inserting = $db->insert();
		
		if($inserting["affected_rows"] > 0){
			javascript("alert('Data berhasil disimpan');");
			javascript("window.location=\"bts_sran_2_2_1.php?token=".$token."&atd_id=".$atd_id."\";");
			exit();
		} else {
		...
		<td>
			...
			<table align="center" border="1">
				...
				<tr>
					...
					<td><?=$f->select("v1_1",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v1_1"], "required");?></td>
				</tr>
				<tr>
					<td>1.2</td>
					<td>Any damages are recorded</td>
					<td><?=$f->select("v1_2",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v1_2"], "required");?></td>
				</tr>
				<tr>
					<td>1.3</td>
					<td>Equipment layout checked,<br>differences to the drawings recorded</td>
					<td><?=$f->select("v1_3",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v1_3"], "required");?></td>
				</tr>
				<tr>
					<td>1.4</td>
					<td>Cabling routes checked,<br>cable trays & ladders installed</td>
					<td><?=$f->select("v1_4",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v1_4"], "required");?></td>
				</tr>
				<tr>
					<td>1.5</td>
					<td>Antenna tower/pole grounding checked</td>
					<td><?=$f->select("v1_5",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v1_5"], "required");?></td>
				</tr>
				<tr align="center">
					<td><b>2</b></td>
				...
				<tr>
					...
					<td><?=$f->select("v2_1",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v2_1"], "required");?></td>
				</tr>
				<tr>
					<td>2.2</td>
					<td>Mounting height checked according<br>to Final Site Configuration</td>
					<td><?=$f->select("v2_2",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v2_2"], "required");?></td>
				</tr>
				<tr>
					<td>2.3</td>
					<td>Antenna direction checked according<br>to Final Site Configuration</td>
					<td><?=$f->select("v2_3",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v2_3"], "required");?></td>
				</tr>
				<tr>
					<td>2.4</td>
					<td>Mechanical tilting angle checked<br>according to Final Site Configuration</td>
					<td><?=$f->select("v2_4",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v2_4"], "required");?></td>
				</tr>
				<tr>
					<td>2.5</td>
					<td>Electrical tilting angle checked<br>according to Final Site Configuration</td>
					<td><?=$f->select("v2_5",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v2_5"], "required");?></td>
				</tr>
				<tr>
					<td>2.6</td>
					<td>Antenna mounting clamps checked,<br>all screws tightened</td>
					<td><?=$f->select("v2_6",[""=>"","1" => "OK","2" => "NOK"],$indottech_bts_sran_2_1_2["v2_6"], "required");?></td>
				</tr>
			</table>
				<br>
			<table width="100%">
				<tr>
					<td><?=$f->input("back","Back","type='button' onclick='window.location=\"bts_sran_2_1_1.php?token=".$token."&atd_id=".$atd_id."\";'");?></td>
