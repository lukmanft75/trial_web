<?php 
	...
	echo "<input type='button' value='Retake Photo' style='width:100%;height:50px;font-size:20px;font-weight:bolder;' onclick=\"window.location='geotagging_mine.php?fromlist=".$fromlist."&current=".$current."&user_id=".$user_id."&token=".$token."&site_id=".$site_id."&sitename=".$sitename."&tagging_at=".$tagging_at."&indottech_geotagging_req_id=".$indottech_geotagging_req_id."&dl_url=".$dl_url."&retake=".$site_id."||".$sitename."||".$tagging_at."||".$indottech_geotagging_req_id."';\">";
