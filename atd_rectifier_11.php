<?php
	...
	foreach($photos_907 as $photo_907){
		$indottech_photos_907 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_907["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_908 as $photo_908){
		$indottech_photos_908 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_908["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_909 as $photo_909){
		$indottech_photos_909 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_909["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_910 as $photo_910){
		$indottech_photos_910 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_910["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_911 as $photo_911){
		$indottech_photos_911 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_911["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_912 as $photo_912){
		$indottech_photos_912 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_912["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_913 as $photo_913){
		$indottech_photos_913 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_913["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_914 as $photo_914){
		$indottech_photos_914 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_914["filename"]."'>&nbsp;";
	}
