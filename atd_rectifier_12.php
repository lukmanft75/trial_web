<?php
	...
	foreach($photos_915 as $photo_915){
		$indottech_photos_915 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_915["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_916 as $photo_916){
		$indottech_photos_916 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_916["filename"]."'>&nbsp;";
	}
