<?php
	...
	foreach($photos_896 as $photo_896){
		$indottech_photos_896 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_896["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_897 as $photo_897){
		$indottech_photos_897 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_897["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_898 as $photo_898){
		$indottech_photos_898 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_898["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_899 as $photo_899){
		$indottech_photos_899 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_899["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_900 as $photo_900){
		$indottech_photos_900 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_900["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_919 as $photo_919){
		$indottech_photos_919 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_919["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_901 as $photo_901){
		$indottech_photos_901 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_901["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_902 as $photo_902){
		$indottech_photos_902 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_902["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_903 as $photo_903){
		$indottech_photos_903 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_903["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_904 as $photo_904){
		$indottech_photos_904 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_904["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_905 as $photo_905){
		$indottech_photos_905 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_905["filename"]."'>&nbsp;";
	}
	...
	foreach($photos_906 as $photo_906){
		$indottech_photos_906 .= "<img height='170' width='170' src='http://{host}/indottech/geophoto/".$photo_906["filename"]."'>&nbsp;";
	}
