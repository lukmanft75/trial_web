...
--================================2018-08-10 09:25==========================
DROP TABLE IF EXISTS indottech_bts_sran_1_1_1;
CREATE TABLE indottech_bts_sran_1_1_1 (
	id int NOT NULL auto_increment,
	atd_id int NOT NULL,
	antena_type_1 varchar(100) NOT NULL,
	antena_type_2 varchar(100) NOT NULL,
	antena_type_3 varchar(100) NOT NULL,
	antena_type_1_isok smallint NOT NULL,
	antena_type_2_isok smallint NOT NULL,
	antena_type_3_isok smallint NOT NULL,
	serialno_1 varchar(100) NOT NULL,
	serialno_2 varchar(100) NOT NULL,
	serialno_3 varchar(100) NOT NULL,
	serialno_1_isok smallint NOT NULL,
	serialno_2_isok smallint NOT NULL,
	serialno_3_isok smallint NOT NULL,
	direction_1 varchar(100) NOT NULL,
	direction_2 varchar(100) NOT NULL,
	direction_3 varchar(100) NOT NULL,
	direction_1_isok smallint NOT NULL,
	direction_2_isok smallint NOT NULL,
	direction_3_isok smallint NOT NULL,
	mechanical_tilt_1 varchar(100) NOT NULL,
	mechanical_tilt_2 varchar(100) NOT NULL,
	mechanical_tilt_3 varchar(100) NOT NULL,
	mechanical_tilt_1_isok smallint NOT NULL,
	mechanical_tilt_2_isok smallint NOT NULL,
	mechanical_tilt_3_isok smallint NOT NULL,
	electrical_tilt_1 varchar(100) NOT NULL,
	electrical_tilt_2 varchar(100) NOT NULL,
	electrical_tilt_3 varchar(100) NOT NULL,
	electrical_tilt_1_isok smallint NOT NULL,
	electrical_tilt_2_isok smallint NOT NULL,
	electrical_tilt_3_isok smallint NOT NULL,
	antenna_height_1 varchar(100) NOT NULL,
	antenna_height_2 varchar(100) NOT NULL,
	antenna_height_3 varchar(100) NOT NULL,
	antenna_height_1_isok smallint NOT NULL,
	antenna_height_2_isok smallint NOT NULL,
	antenna_height_3_isok smallint NOT NULL,
	created_at datetime DEFAULT NULL,
	created_by varchar(100) NOT NULL,
	created_ip varchar(20) DEFAULT NULL,
	updated_at datetime DEFAULT NULL,
...
DROP TABLE IF EXISTS indottech_bts_sran_1_1_2;
CREATE TABLE indottech_bts_sran_1_1_2 (
	id int NOT NULL auto_increment,
	atd_id int NOT NULL,
	jumper_length_1 double NOT NULL,
	jumper_length_2 double NOT NULL,
	jumper_length_3 double NOT NULL,
	optical_length_1 double NOT NULL,
	optical_length_2 double NOT NULL,
	optical_length_3 double NOT NULL,
	powercable_length_1 double NOT NULL,
	powercable_length_2 double NOT NULL,
	powercable_length_3 double NOT NULL,
	created_at datetime DEFAULT NULL,
	created_by varchar(100) NOT NULL,
	created_ip varchar(20) DEFAULT NULL,
	updated_at datetime DEFAULT NULL,
...
DROP TABLE IF EXISTS indottech_bts_sran_1_1_3;
CREATE TABLE indottech_bts_sran_1_1_3 (
	id int NOT NULL auto_increment,
	atd_id int NOT NULL,
	fxdb1_1 varchar(100) NOT NULL,
	fxdb1_2 varchar(100) NOT NULL,
	fxdb1_3 varchar(100) NOT NULL,
	fxdb1_4 varchar(100) NOT NULL,
	fxdb1_5 varchar(100) NOT NULL,
	fxdb1_6 varchar(100) NOT NULL,
	fxdb2_1 varchar(100) NOT NULL,
	fxdb2_2 varchar(100) NOT NULL,
	fxdb2_3 varchar(100) NOT NULL,
	fxdb2_4 varchar(100) NOT NULL,
	fxdb2_5 varchar(100) NOT NULL,
	fxdb2_6 varchar(100) NOT NULL,
	fxed1_1 varchar(100) NOT NULL,
	fxed1_2 varchar(100) NOT NULL,
	fxed1_3 varchar(100) NOT NULL,
	fxed1_4 varchar(100) NOT NULL,
	fxed1_5 varchar(100) NOT NULL,
	fxed1_6 varchar(100) NOT NULL,
	fxed2_1 varchar(100) NOT NULL,
	fxed2_2 varchar(100) NOT NULL,
	fxed2_3 varchar(100) NOT NULL,
	fxed2_4 varchar(100) NOT NULL,
	fxed2_5 varchar(100) NOT NULL,
	fxed2_6 varchar(100) NOT NULL,
	frgu1_1 varchar(100) NOT NULL,
	frgu1_2 varchar(100) NOT NULL,
	frgu1_3 varchar(100) NOT NULL,
	frgu1_4 varchar(100) NOT NULL,
	frgu1_5 varchar(100) NOT NULL,
	frgu1_6 varchar(100) NOT NULL,
	frgu2_1 varchar(100) NOT NULL,
	frgu2_2 varchar(100) NOT NULL,
	frgu2_3 varchar(100) NOT NULL,
	frgu2_4 varchar(100) NOT NULL,
	frgu2_5 varchar(100) NOT NULL,
	frgu2_6 varchar(100) NOT NULL,
	created_at datetime DEFAULT NULL,
	created_by varchar(100) NOT NULL,
	created_ip varchar(20) DEFAULT NULL,
	updated_at datetime DEFAULT NULL,
...
DROP TABLE IF EXISTS indottech_bts_sran_1_1_4;
CREATE TABLE indottech_bts_sran_1_1_4 (
	id int NOT NULL auto_increment,
	atd_id int NOT NULL,
	rectifier double NOT NULL,
	pln double NOT NULL,
	created_at datetime DEFAULT NULL,
	created_by varchar(100) NOT NULL,
	created_ip varchar(20) DEFAULT NULL,
...
DROP TABLE IF EXISTS indottech_bts_sran_2_1_1;
CREATE TABLE indottech_bts_sran_2_1_1 (
	id int NOT NULL auto_increment,
	atd_id int NOT NULL,
	v1_1 smallint NOT NULL,
	v1_2 smallint NOT NULL,
	v1_3 smallint NOT NULL,
	v1_4 smallint NOT NULL,
	v1_5 smallint NOT NULL,
	v2_1 smallint NOT NULL,
	v2_2 smallint NOT NULL,
	v2_3 smallint NOT NULL,
	v3_1 smallint NOT NULL,
	v3_2 smallint NOT NULL,
	v3_3 smallint NOT NULL,
	v3_4 smallint NOT NULL,
	created_at datetime DEFAULT NULL,
	created_by varchar(100) NOT NULL,
	created_ip varchar(20) DEFAULT NULL,
	updated_at datetime DEFAULT NULL,
...
DROP TABLE IF EXISTS indottech_bts_sran_2_1_2;
CREATE TABLE indottech_bts_sran_2_1_2 (
	id int NOT NULL auto_increment,
	atd_id int NOT NULL,
	v1_1 smallint NOT NULL,
	v1_2 smallint NOT NULL,
	...
	v2_2 smallint NOT NULL,
	v2_3 smallint NOT NULL,
	v2_4 smallint NOT NULL,
	v2_5 smallint NOT NULL,
	v2_6 smallint NOT NULL,
	created_at datetime DEFAULT NULL,
	created_by varchar(100) NOT NULL,
	created_ip varchar(20) DEFAULT NULL,
	updated_at datetime DEFAULT NULL,
...
DROP TABLE IF EXISTS indottech_bts_sran_2_2_1;
CREATE TABLE indottech_bts_sran_2_2_1 (
	id int NOT NULL auto_increment,
	atd_id int NOT NULL,
...
DROP TABLE IF EXISTS indottech_bts_sran_2_2_2;
CREATE TABLE indottech_bts_sran_2_2_2 (
	id int NOT NULL auto_increment,
	atd_id int NOT NULL,
	v1 varchar(100) NOT NULL,
	v2 varchar(100) NOT NULL,
	...
	v12 varchar(100) NOT NULL,
	v13 varchar(100) NOT NULL,
	v14 varchar(100) NOT NULL,
	v15 varchar(100) NOT NULL,
	v16 varchar(100) NOT NULL,
	created_at datetime DEFAULT NULL,
	created_by varchar(100) NOT NULL,
	created_ip varchar(20) DEFAULT NULL,
	updated_at datetime DEFAULT NULL,
